@extends('omis.partials.layouts')
 ...
 @csrf 
 @method('PUT')
<div class="row"><div class="col-lg-6">{{createText("departmentName_id","departmentName_id","Department Name Id",'',$data->departmentName_id)}}
</div><div class="col-lg-6">{{createText("departmentHead","departmentHead","Department Head",'',$data->departmentHead)}}
