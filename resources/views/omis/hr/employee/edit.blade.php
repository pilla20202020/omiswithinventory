                            ...
                            <div class="container">
                                <form action="" class="row gy-3 mt-2">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <?php createSelect('gender', 'gender', '', '', ['Male', 'Female', 'Other']); ?>
                                    </div>
                                    <div class="col-md-6">
                                        <?php createLabel('company', '', 'Company'); ?>
                                        <?php createSelect('company', 'company', '', '', ['1', '2', '3']); ?>
                                    </div>
                                    <div class="col-md-6">
                                        <?php createLabel('designation', '', 'Designation'); ?>
                                        <?php createSelect('designation', 'designation', '', '', ['1', '2', '3']); ?>
                                    </div>
                                    <div class="form-control-wrap col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <?php createSelect('attendanceType', 'attendanceType', '', '', ['General', 'Online']); ?>
                                    </div>
                                    <div class="form-control-wrap col-md-6">
