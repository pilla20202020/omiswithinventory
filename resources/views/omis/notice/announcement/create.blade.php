...
</div><div class="col-lg-6">{{createLabel('announcementSummary','form-label col-form-label','Announcement Summary')}}{{createTextArea("","announcementSummary","",'')}}
</div><div class="col-lg-6">{{createText("announcementDepartment","announcementDepartment","Announcement Department")}}
</div><div class="col-lg-6">{{createDate("announcementStartDate","announcementStartDate","Announcement StartDate",'','')}}
</div><div class="col-lg-6">{{createDate("announcementEndDate","announcementEndDate","Announcement EndDate",'','')}}
...
</div><div class="col-lg-6">{{createLabel('remarks','form-label col-form-label','Remarks')}}{{createTextArea("","remarks","3","")}}
