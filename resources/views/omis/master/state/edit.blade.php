@extends('omis.partials.layouts')
 ...
 @csrf 
 @method('PUT')
<div class="row"><div class="col-lg-6">{{createText("stateName","stateName","StateName",'',$data->stateName)}}
...
</div><div class="col-lg-6"><label for="remarks" class="form-label col-form-label">Remarks</label>{{createTextArea("remarks","remarks","", $data->remarks)}}
